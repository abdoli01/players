...
const startingXI: Player[] = [
    ...
    { id: 6, number: 7, top: "46%", left: "50%" },
    { id: 7, number: 10, top: "56%", left: "50%" },
...
export default function FootballPitch() {
    return (
        <div className="bg-black p-6 rounded-xl w-fit">
            {/* FIELD */}
            <div className="relative w-[820px] aspect-[2.25/1] border-2 border-gray-400">
                ...
                {/* PENALTY AREA */}
                <div className="absolute top-[18%] left-4 w-44 h-[64%] border border-gray-500" />

                {/* GOAL AREA (بزرگ‌تر) */}
                <div className="absolute top-[34%] left-4 w-24 h-[32%] border border-gray-500" />

                {/* PENALTY ARC (OUTSIDE ONLY) */}
                <div className="absolute top-1/2 left-[112px] w-28 h-28 border border-gray-500 rounded-full -translate-y-1/2 clip-left" />

                {/* ================= RIGHT SIDE ================= */}

                {/* PENALTY AREA */}
                <div className="absolute top-[18%] right-4 w-44 h-[64%] border border-gray-500" />

                {/* GOAL AREA */}
                <div className="absolute top-[34%] right-4 w-24 h-[32%] border border-gray-500" />

                {/* PENALTY ARC (OUTSIDE ONLY) */}
                <div className="absolute top-1/2 right-[112px] w-28 h-28 border border-gray-500 rounded-full -translate-y-1/2 clip-right" />
