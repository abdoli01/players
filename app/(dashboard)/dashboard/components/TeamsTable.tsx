...
import { Team, TeamSearchParams } from "@/types/team";
...
export function TeamsTable() {
    ...
    // Search state
    // -----------------------
    const [searchParams, setSearchParams] = React.useState<TeamSearchParams>({
        q: "",
        fullName: "",
        shortName: "",
        fullNameEn: "",
    ...
    // Fetch data
    // -----------------------
    const { data: allTeams = [], isLoading: isLoadingAll } = useGetTeamsQuery();

    const {
        data: filteredTeams = [],
        isLoading: isLoadingFiltered,
    } = useSearchTeamsQuery(searchParams);

    const hasFilters = Object.values(searchParams).some(Boolean);
    const teams = hasFilters ? filteredTeams : allTeams;
    ...
    const columns: ColumnDef<Team>[] = [
        ...
        {
            accessorKey: "club.fullName",
            header: t("club"),
        },
        {
            accessorKey: "sport.fullName",
            header: t("sport"),
        },
        {
            accessorKey: "teamLevel.fullName",
            header: t("teamLevel"),
        },
        {
            accessorKey: "continent.fullName",
            header: t("continent"),
        },
        {
