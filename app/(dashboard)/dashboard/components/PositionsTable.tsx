...
import { Position, PositionSearchParams } from "@/types/position";
...
export function PositionsTable() {
    ...
    const [searchParams, setSearchParams] =
        React.useState<PositionSearchParams>({
            q: "",
            fullName: "",
            shortName: "",
            fullNameEn: "",
    ...
    // Fetch data
    // -----------------------
    const { data: allPositions = [], isLoading: isLoadingAll } =
        useGetPositionsQuery();

    const { data: filteredPositions = [], isLoading: isLoadingFiltered } =
        useSearchPositionsQuery(searchParams);

    const hasFilters = Object.values(searchParams).some(Boolean);
    const positions = hasFilters ? filteredPositions : allPositions;
                ...
                return (
                    <DropdownMenu dir={isRtl ? "rtl" : "ltr"}>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            {/* later */}
                            {/* <EditPositionDialog positionData={position} /> */}
                            {/* <DeletePositionDialog positionData={position} /> */}
                        </DropdownMenuContent>
                    </DropdownMenu>
                );
            },
    ...
    return (
        <div className="w-full">
            <PageHeader title={tp("SideBar.positions")} />
