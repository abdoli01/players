...
export function ClubsTable() {
    ...
    const [searchParams, setSearchParams] =
        React.useState<ClubSearchParams>({
            q: "",
            fullName: "",
            fullNameEn: "",
            shortName: "",
    ...
    // Fetch data
    // -----------------------
    const { data: allClubs = [], isLoading: isLoadingAll } =
        useGetClubsQuery();

    const {
        data: filteredClubs = [],
        isLoading: isLoadingFiltered,
    } = useSearchClubsQuery(searchParams);

    const hasFilters = Object.values(searchParams).some(
        (v) => v !== "" && v !== undefined
    );
    const clubs = hasFilters ? filteredClubs : allClubs;
    ...
    // Table
    // -----------------------
    const table = useReactTable<Club>({
        data: clubs,
        columns,
