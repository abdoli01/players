...
} from "@/services/api/teamLevelsApi";
import {
    TeamLevel,
...
// بعداً:
// import { CreateTeamLevelDialog } from "../components/CreateTeamLevelDialog";
// import { EditTeamLevelDialog } from "../components/EditTeamLevelDialog";
...
export function TeamLevelsTable() {
    ...
    const [searchParams, setSearchParams] =
        React.useState<TeamLevelSearchParams>({
            q: "",
            fullName: "",
            shortName: "",
            fullNameEn: "",
    ...
    // Fetch data
    // -----------------------
    const { data: allTeamLevels = [], isLoading: isLoadingAll } =
        useGetTeamLevelsQuery();

    const {
        data: filteredTeamLevels = [],
        isLoading: isLoadingFiltered,
    } = useSearchTeamLevelsQuery(searchParams);

    const hasFilters = Object.values(searchParams).some(Boolean);
    const teamLevels = hasFilters
        ? filteredTeamLevels
        : allTeamLevels;
    ...
    // Columns
    // -----------------------
    const columns: ColumnDef<TeamLevel>[] = [
        {
    ...
    // Table
    // -----------------------
    const table = useReactTable<TeamLevel>({
        data: teamLevels,
        columns,
