...
} from "@/services/api/languagesApi";
...
export function LanguagesTable() {
    ...
    const [searchParams, setSearchParams] =
        React.useState<LanguageSearchParams>({
            q: "",
            fullName: "",
            shortName: "",
            fullNameEn: "",
    ...
    // Fetch data
    // -----------------------
    const { data: allLanguages = [], isLoading: isLoadingAll } =
        useGetLanguagesQuery();

    const { data: filteredLanguages = [], isLoading: isLoadingFiltered } =
        useSearchLanguagesQuery(searchParams);

    const hasFilters = Object.values(searchParams).some(Boolean);
    const languages = hasFilters ? filteredLanguages : allLanguages;
                ...
                return (
                    <DropdownMenu dir={isRtl ? "rtl" : "ltr"}>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            {/* later */}
                            {/* <EditLanguageDialog languageData={language} /> */}
                            {/* <DeleteLanguageDialog languageData={language} /> */}
                        </DropdownMenuContent>
                    </DropdownMenu>
                );
            },
    ...
    return (
        <div className="w-full">
            <PageHeader title={tp("SideBar.languages")} />
