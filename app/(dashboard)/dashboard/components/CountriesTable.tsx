...
} from "@/services/api/countriesApi";
...
// import { EditCountryDialog } from "../components/EditCountryDialog";
...
export function CountriesTable() {
    ...
    const [searchParams, setSearchParams] =
        React.useState<CountrySearchParams>({
            q: "",
            fullName: "",
            shortName: "",
            fullNameEn: "",
    ...
    // Fetch data
    // -----------------------
    const { data: allCountries = [], isLoading: isLoadingAll } =
        useGetCountriesQuery();

    const {
        data: filteredCountries = [],
        isLoading: isLoadingFiltered,
    } = useSearchCountriesQuery(searchParams);

    const hasFilters = Object.values(searchParams).some(Boolean);
    const countries = hasFilters ? filteredCountries : allCountries;
    ...
    const columns: ColumnDef<Country>[] = [
        ...
        //                 <DropdownMenuSeparator />
        //                 {/*<EditCountryDialog country={row.original} />*/}
        //             </DropdownMenuContent>
        //         </DropdownMenu>
        //     ),
        // },
