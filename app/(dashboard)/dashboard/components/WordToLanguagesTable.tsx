...
} from "@/services/api/wordToLanguagesApi";
...
export function WordToLanguagesTable() {
    ...
    const [searchParams, setSearchParams] =
        React.useState<WordToLanguageSearchParams>({
            q: "",
            wordId: "",
            languageId: "",
            title: "",
    ...
    const { data: filteredItems = [], isLoading: isLoadingFiltered } =
        useSearchWordToLanguagesQuery(searchParams);
    ...
    // Columns
    // -----------------------
    const columns: ColumnDef<WordToLanguage>[] = [
        {
            accessorKey: "wordId",
            header: t("wordId"),
        },
                ...
                return (
                    <DropdownMenu dir={isRtl ? "rtl" : "ltr"}>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            {/* later */}
                            {/* <EditWordToLanguageDialog data={item} /> */}
                            {/* <DeleteWordToLanguageDialog data={item} /> */}
                        </DropdownMenuContent>
                    </DropdownMenu>
                );
            },
    ...
    // Table
    // -----------------------
    const table = useReactTable<WordToLanguage>({
        data,
        columns,
    ...
    return (
        <div className="w-full">
            <PageHeader title={tp("SideBar.wordToLanguages")} />
            ...
            <div className="flex flex-wrap gap-4 mb-4">
                ...
                <div className="flex flex-col gap-1">
                    <Label>{t("wordId")}</Label>
                    <Input
                        value={searchParams.wordId ?? ""}
                        onChange={(e) =>
                            setSearchParams((prev) => ({
                                ...prev,
