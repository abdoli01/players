...
} from "@/services/api/matchTransactionsApi";
import {
    MatchTransaction,
...
export function MatchTransactionsTable() {
    ...
    const [searchParams, setSearchParams] =
        React.useState<MatchTransactionSearchParams>({
            q: "",
            matchId: "",
    ...
    const { data: filteredData = [], isLoading: isLoadingFiltered } =
        useSearchMatchTransactionsQuery(searchParams);
    ...
    // Columns
    // -----------------------
    const columns: ColumnDef<MatchTransaction>[] = [
        {
            accessorKey: "matchId",
            header: t("matchId"),
        },
                ...
                return (
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            {/* later */}
                            {/* <EditMatchTransactionDialog data={item} /> */}
                            {/* <DeleteMatchTransactionDialog data={item} /> */}
                        </DropdownMenuContent>
                    </DropdownMenu>
                );
            },
    ...
    // Table
    // -----------------------
    const table = useReactTable<MatchTransaction>({
        data,
        columns,
    ...
    return (
        <div className="w-full">
            <PageHeader title={t("matchTransactions")} />
