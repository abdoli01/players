...
} from "@/services/api/transactionLabelsApi";
...
export function TransactionLabelsTable() {
    ...
    const filteredData = React.useMemo(() => {
        if (!search.trim()) return transactionLabels;

        return transactionLabels.filter((item) => {
            return (
    ...
    }, [transactionLabels, search]);

    const columns: ColumnDef<TransactionLabel>[] = [
        {
            accessorKey: "key",
            header: t("key"),
        },
    ...
    const table = useReactTable<TransactionLabel>({
        data: filteredData,
        columns,
    ...
    return (
        <div className="w-full">
            ...
            <PageHeader
                title={tp("SideBar.transactionLabels")}
            />
